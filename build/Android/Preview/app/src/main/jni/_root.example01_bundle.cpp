...
static void example01_bundle_build(uType* type)
{
    ...
    type->Reflection.SetFields(6,
        new uField("Cardjs493886af", 0),
        new uField("Getjsb5045a25", 1),
        new uField("Homejs20a25a68", 2),
        new uField("MainViewe8f1283a", 3),
        new uField("QRjsd8136104", 4),
        new uField("Upjs24565a6a", 5));
}
