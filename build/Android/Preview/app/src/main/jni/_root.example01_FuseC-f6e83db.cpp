...
{
    uStackFrame __("example01_FuseControlsImage_Url_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("example01_FuseControlsImage_Url_Property", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
