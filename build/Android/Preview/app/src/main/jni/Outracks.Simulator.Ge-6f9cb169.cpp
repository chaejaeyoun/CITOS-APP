...
static void GeneratedApplication_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("10.1.62.13");
    ::STRINGS[2] = uString::Const("/Users/devel/github/CITOS-APP/example01.unoproj");
    ::STRINGS[3] = uString::Const("example01");
