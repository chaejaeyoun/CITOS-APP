...
struct Cardpage : ::g::Fuse::Controls::Page
{
    ...
    static uSStrong<uArray*>& __g_static_nametable1() { return Cardpage_typeof()->Init(), __g_static_nametable1_; }
    static ::g::Uno::UX::Selector __selector0_;
    static ::g::Uno::UX::Selector& __selector0() { return Cardpage_typeof()->Init(), __selector0_; }
    static ::g::Uno::UX::Selector __selector1_;
    static ::g::Uno::UX::Selector& __selector1() { return Cardpage_typeof()->Init(), __selector1_; }

    void ctor_8(::g::Fuse::Navigation::Router* router1);
    void InitializeUX();
    static Cardpage* New5(::g::Fuse::Navigation::Router* router1);
};
// }
