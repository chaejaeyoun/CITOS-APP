...
::g::Java::Object* QreaderImpl::Init()
{
    QreaderImpl_typeof()->Init();
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Init381", "()Ljava/lang/Object;");
...
bool QreaderImpl::OnRecieved(int32_t requestCode, int32_t resultCode, ::g::Java::Object* data)
{
    QreaderImpl_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "OnRecieved382", "(IILjava/lang/Object;)Z");
...
void QreaderImpl::ScannerImpl()
{
    QreaderImpl_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "ScannerImpl386", "()V");
