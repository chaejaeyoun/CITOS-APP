...
{
    MainView__Template3::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"QRpage"*/]);
}

static void MainView__Template3_build(uType* type)
{
    ::STRINGS[0] = uString::Const("QRpage");
...
{
    ::g::QRpage* __self1 = ::g::QRpage::New4(uPtr(__this->__parent1)->router);
