...
{
    MainView__Template2::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"Getpage"*/]);
}

static void MainView__Template2_build(uType* type)
{
    ::STRINGS[0] = uString::Const("Getpage");
...
{
    ::g::Getpage* __self1 = ::g::Getpage::New5(uPtr(__this->__parent1)->router);
