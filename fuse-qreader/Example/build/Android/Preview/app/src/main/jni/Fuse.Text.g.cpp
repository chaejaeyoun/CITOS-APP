...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\Fuse.Text\1.9.0\Renderer.uno
// --------------------------------------------------------------------------------
...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\Fuse.Text\1.9.0\Substring.uno
// ---------------------------------------------------------------------------------
...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\Fuse.Text\1.9.0\Implementation\SinglyLinkedList.uno
// -------------------------------------------------------------------------------------------------------
...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\Fuse.Text\1.9.0\Fallback.uno
// --------------------------------------------------------------------------------
...
static void FallingBackFont_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:/Users/\354\261\204\354\236\254\354\234\244\354\234\265\355\225\251IT\355\225\231\353\266\200/AppData/Local/Fusetools/Packages/Fuse.Text/1.9.0/Fallback.uno");
...
void FallingBackFont__Shape_fn(FallingBackFont* __this, ::g::Fuse::Text::Substring* text, int32_t* fontIndex, int32_t* dir, uArray** __retval)
{
    ...
    int32_t dir_ = *dir;
    ::g::Uno::Diagnostics::Debug::Assert(fontIndex_ == 0, ::STRINGS[2/*"fontIndex =...*/], ::STRINGS[1/*"C:/Users/채재...*/], 76, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int32_t>(::g::Uno::Int_typeof(), fontIndex_), uBox<int32_t>(::g::Uno::Int_typeof(), 0)));
...
void FallingBackFont::ctor_1(uArray* fonts)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 > 0, ::STRINGS[0/*"fonts.Lengt...*/], ::STRINGS[1/*"C:/Users/채재...*/], 45, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int32_t>(::g::Uno::Int_typeof(), assert1), uBox<int32_t>(::g::Uno::Int_typeof(), 0)));
    Fonts = fonts;
}
...
void FallingBackFontFace::ctor_1(uArray* fontFaces)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 > 0, ::STRINGS[3/*"fontFaces.L...*/], ::STRINGS[1/*"C:/Users/채재...*/], 13, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int32_t>(::g::Uno::Int_typeof(), assert1), uBox<int32_t>(::g::Uno::Int_typeof(), 0)));
    FontFaces = fontFaces;
}
...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\Fuse.Text\1.9.0\FontFace.uno
// --------------------------------------------------------------------------------
...
static void Font_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("C:\\Users\\\354\261\204\354\236\254\354\234\244\354\234\265\355\225\251IT\355\225\231\353\266\200\\AppData\\Local\\Fusetools\\Packages\\Fuse.Text\\1.9.0\\FontFace.uno");
...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\Fuse.Text\1.9.0\GlyphAtlas.uno
// ----------------------------------------------------------------------------------
...
static void GlyphAtlas_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("C:/Users/\354\261\204\354\236\254\354\234\244\354\234\265\355\225\251IT\355\225\231\353\266\200/AppData/Local/Fusetools/Packages/Fuse.Text/1.9.0/GlyphAtlas.uno");
...
::g::Fuse::Text::SubTexture GlyphAtlas::Add(::g::Uno::Content::Images::Bitmap* bitmap)
{
    ...
    assert1 = format == 1;
    assert2 = format == 3;
    ::g::Uno::Diagnostics::Debug::Assert(assert1 || assert2, ::STRINGS[9/*"(format == ...*/], ::STRINGS[10/*"C:/Users/채재...*/], 27, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox(::g::Uno::Bool_typeof(), assert1), uBox(::g::Uno::Bool_typeof(), assert2)));
...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\Fuse.Text\1.9.0\LazyFontFace.uno
// ------------------------------------------------------------------------------------
...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\Fuse.Text\1.9.0\LineBreaks.uno
// ----------------------------------------------------------------------------------
...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\Fuse.Text\1.9.0\Measure.uno
// -------------------------------------------------------------------------------
...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\Fuse.Text\1.9.0\ShapedRun.uno
// ---------------------------------------------------------------------------------
...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\Fuse.Text\1.9.0\Shape.uno
// -----------------------------------------------------------------------------
...
static void SubstringExtensions_build(uType* type)
{
    ...
    ::STRINGS[15] = uString::Const("C:/Users/\354\261\204\354\236\254\354\234\244\354\234\265\355\225\251IT\355\225\231\353\266\200/AppData/Local/Fusetools/Packages/Fuse.Text/1.9.0/Substring.uno");
...
::g::Fuse::Text::Substring* SubstringExtensions::InclusiveRange(::g::Fuse::Text::Substring* s, int32_t start, int32_t end)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(!assert1, ::STRINGS[14/*"!Fuse.Text....*/], ::STRINGS[15/*"C:/Users/채재...*/], 295, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 1, uBox(::g::Uno::Bool_typeof(), assert1)));

    if (SubstringExtensions::IsLeadingSurrogate(s->Item(end)))
        ++end;

    ::g::Uno::Diagnostics::Debug::Assert(end < s->Length, ::STRINGS[16/*"end < s.Len...*/], ::STRINGS[15/*"C:/Users/채재...*/], 298, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int32_t>(::g::Uno::Int_typeof(), end), uBox<int32_t>(::g::Uno::Int_typeof(), s->Length)));
...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\Fuse.Text\1.9.0\TextureAtlas.uno
// ------------------------------------------------------------------------------------
...
static void TextureAtlas_build(uType* type)
{
    ...
    ::STRINGS[19] = uString::Const("C:/Users/\354\261\204\354\236\254\354\234\244\354\234\265\355\225\251IT\355\225\231\353\266\200/AppData/Local/Fusetools/Packages/Fuse.Text/1.9.0/TextureAtlas.uno");
...
::g::Fuse::Text::SubTexture TextureAtlas::Add(::g::Uno::Content::Images::Bitmap* bitmap)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 == _format, ::STRINGS[18/*"bitmap.Form...*/], ::STRINGS[19/*"C:/Users/채재...*/], 50, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int32_t>(::g::Uno::Graphics::Format_typeof(), assert1), uBox<int32_t>(::g::Uno::Graphics::Format_typeof(), _format)));
...
void TextureAtlas::Blit(::g::Uno::Content::Images::Bitmap* dst, ::g::Uno::Content::Images::Bitmap* src, ::g::Uno::Int2 dstPos)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(::g::Uno::Recti__New2(::g::Uno::Int2__New1(0), uPtr(dst)->Size()).Contains1(assert2), ::STRINGS[21/*"(&new Uno.R...*/], ::STRINGS[19/*"C:/Users/채재...*/], 96, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 1, uBox(::g::Uno::Recti_typeof(), assert2)));
    assert3 = src->Format();
    assert4 = dst->Format();
    ::g::Uno::Diagnostics::Debug::Assert(assert3 == assert4, ::STRINGS[22/*"src.Format ...*/], ::STRINGS[19/*"C:/Users/채재...*/], 97, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int32_t>(::g::Uno::Graphics::Format_typeof(), assert3), uBox<int32_t>(::g::Uno::Graphics::Format_typeof(), assert4)));
...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\Fuse.Text\1.9.0\Truncate.uno
// --------------------------------------------------------------------------------
...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\Fuse.Text\1.9.0\Wrap.uno
// ----------------------------------------------------------------------------
