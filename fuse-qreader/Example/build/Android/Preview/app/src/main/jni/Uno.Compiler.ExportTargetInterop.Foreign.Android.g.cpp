...
jint JNICALL callUno_QreaderImpl_RC_BARCODE_CAPTUREGet385(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
void JNICALL callUno_QreaderImpl_Cancelled387(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_QreaderImpl_Picked386(JNIEnv *env,jclass clazz,jobject result)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void ExternBlockHost::RegisterFunctions()
{
    ...
    {(char* const)"callUno_QreaderImpl_RC_BARCODE_CAPTUREGet385", (char* const)"()I", (void *)&callUno_QreaderImpl_RC_BARCODE_CAPTUREGet385},
    {(char* const)"callUno_QreaderImpl_Picked386", (char* const)"(Ljava/lang/String;)V", (void *)&callUno_QreaderImpl_Picked386},
    {(char* const)"callUno_QreaderImpl_Cancelled387", (char* const)"()V", (void *)&callUno_QreaderImpl_Cancelled387},
    };
    int funcCount = 126;
