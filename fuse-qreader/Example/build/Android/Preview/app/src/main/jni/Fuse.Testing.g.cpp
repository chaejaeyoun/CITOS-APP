...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\Fuse.Testing\1.9.0\JavaScriptTest.uno
// -----------------------------------------------------------------------------------------
...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\Fuse.Testing\1.9.0\TestRootPanel.uno
// ----------------------------------------------------------------------------------------
        ...
        {
            {
                ...
                catch (const uThrowable& __t)
                {
                    ...
                    if (testFailedException != NULL)
                        ::g::Uno::Testing::Assert::Fail(uPtr(testFailedException)->Message(), uString::Const("C:\\Users\\\354\261\204\354\236\254\354\234\244\354\234\265\355\225\251IT\355\225\231\353\266\200\\AppData\\Local\\Fusetools\\Packages\\Fuse.Testing\\1.9.0\\TestRootPanel.uno"), 115, uString::Const("RunTest"));
                    else
                        throw __t;
                }
            }
        ...
        {
            {
                while (enum2.MoveNext(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Diagnostic_typeof(), NULL)))
                {
                    ...
                    ::g::Uno::Testing::Assert::Fail(uPtr(e1)->ToString(), uString::Const("C:\\Users\\\354\261\204\354\236\254\354\234\244\354\234\265\355\225\251IT\355\225\231\353\266\200\\AppData\\Local\\Fusetools\\Packages\\Fuse.Testing\\1.9.0\\TestRootPanel.uno"), 127, uString::Const("RunTest"));
                }
            }
        }
