// This file was generated based on C:/Users/채재윤융합IT학부/Documents/Fuse/example01/fuse-qreader/Example/build/Android/Preview/cache/ux15/Example.unoproj.g.uno.
...
{
    uStackFrame __("Example_FuseControlsTextControl_Value_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("Example_FuseControlsTextControl_Value_Property", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
