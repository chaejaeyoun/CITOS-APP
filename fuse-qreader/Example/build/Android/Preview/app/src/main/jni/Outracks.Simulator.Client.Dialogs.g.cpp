...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\Fuse.Preview.Core\0.1.0\.uno\ux15\Outracks.Simulator.Client.Dialogs.LoadingScreen.g.uno
// -------------------------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\Fuse.Preview.Core\0.1.0\.uno\ux15\Outracks.Simulator.Client.Dialogs.ModalDialog.g.uno
// -----------------------------------------------------------------------------------------------------------------------------------------
...
void ModalDialog::InitializeUX()
{
    ...
    temp15->File(::g::Uno::UX::BundleFileSource::New1(::g::FusePreviewCore_bundle::fight41ec1b12()));
    temp->TextWrapping(1);
    temp->FontSize(25.0f);
    temp->TextAlignment(1);
    temp->Alignment(8);
