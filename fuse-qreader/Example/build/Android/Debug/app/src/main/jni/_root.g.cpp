...
static void FuseScriptingJavaScript_bundle__cctor__fn(uType* __type)
{
    ...
    FuseScriptingJavaScript_bundle::Diagnostics53845d2e_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[138/*"Fuse.Script...*/]))->GetFile(::STRINGS[139/*"diagnostics...*/]);
    FuseScriptingJavaScript_bundle::es6promisemin01b0c727_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[138/*"Fuse.Script...*/]))->GetFile(::STRINGS[140/*"es6-promise...*/]);
    FuseScriptingJavaScript_bundle::Observabled145fbdf_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[138/*"Fuse.Script...*/]))->GetFile(::STRINGS[141/*"observable-...*/]);
    FuseScriptingJavaScript_bundle::setTimeoutcd42f00f_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[138/*"Fuse.Script...*/]))->GetFile(::STRINGS[142/*"settimeout-...*/]);
    FuseScriptingJavaScript_bundle::TreeObservablee217cda9_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[138/*"Fuse.Script...*/]))->GetFile(::STRINGS[143/*"treeobserva...*/]);
}
