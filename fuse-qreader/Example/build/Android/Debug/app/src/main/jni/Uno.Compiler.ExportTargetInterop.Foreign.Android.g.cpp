...
jint JNICALL callUno_QreaderImpl_RC_BARCODE_CAPTUREGet383(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
void JNICALL callUno_QreaderImpl_Cancelled385(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_QreaderImpl_Picked384(JNIEnv *env,jclass clazz,jobject result)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\UnoCore\1.9.0\Source\Uno\Compiler\ExportTargetInterop\Foreign\Android\ExternBlockHost.uno
// ---------------------------------------------------------------------------------------------------------------------------------------------
...
void ExternBlockHost::RegisterFunctions()
{
    ...
    {(char* const)"callUno_QreaderImpl_RC_BARCODE_CAPTUREGet383", (char* const)"()I", (void *)&callUno_QreaderImpl_RC_BARCODE_CAPTUREGet383},
    {(char* const)"callUno_QreaderImpl_Picked384", (char* const)"(Ljava/lang/String;)V", (void *)&callUno_QreaderImpl_Picked384},
    {(char* const)"callUno_QreaderImpl_Cancelled385", (char* const)"()V", (void *)&callUno_QreaderImpl_Cancelled385},
    };
    int funcCount = 126;
...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\UnoCore\1.9.0\Source\Uno\Compiler\ExportTargetInterop\Foreign\Android\UnoArrayEntrypoints.uno
// -------------------------------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\채재윤융합IT학부\AppData\Local\Fusetools\Packages\UnoCore\1.9.0\Source\Uno\Compiler\ExportTargetInterop\Foreign\Android\JavaUnoObject.uno
// -------------------------------------------------------------------------------------------------------------------------------------------
