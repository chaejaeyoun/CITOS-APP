...
static void Gesture_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("C:\\Users\\\354\261\204\354\236\254\354\234\244\354\234\265\355\225\251IT\355\225\231\353\266\200\\AppData\\Local\\Fusetools\\Packages\\Fuse.Nodes\\1.9.0\\Input\\Gesture.uno");
...
void Gesture::OnPointerMoved(uObject* sender, ::g::Fuse::Input::PointerMovedArgs* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[9/*"Missing Los...*/], uBox<int32_t>(::g::Uno::Int_typeof(), uPtr(args)->PointIndex())), this, ::STRINGS[10/*"C:\\Users\\...*/], 281, ::STRINGS[11/*"OnPointerMo...*/]);
        LostCapture(true);
        return;
    }
